  ...
  return (
    <div className="relative flex items-center">
      ...
      <input
        ...
        placeholder="0,00"
        className="w-full text-right bg-transparent pl-8 pr-2 py-2.5 rounded-lg focus:outline-none focus:bg-background focus:ring-2 focus:ring-ring text-base font-semibold tabular-nums min-h-[44px]"
